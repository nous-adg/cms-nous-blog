...
export const BlogSidebar: React.FC<BlogSidebarProps> = ({ relatedPosts, currentPost }) => {
  ...
  return (
    <aside className="space-y-8 mt-12">
      <div className="glass rounded-lg border border-white/5 p-6">
        <h3 className="text-lg font-bold text-[var(--color-secondary)] mb-4">Compartir</h3>
      ...
      {relatedPosts && relatedPosts.length > 0 && (
        <div>
          <h3 className="md:text-2xl text-xl font-bold text-[var(--color-secondary)] mb-8">Posts relacionados</h3>
