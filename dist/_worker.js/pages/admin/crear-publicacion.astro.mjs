...
import { k as getDefaultExportFromCjs, e as createComponent, l as renderComponent, r as renderTemplate, m as maybeRenderHead } from "../../chunks/astro/server_raLtdS6r.mjs";
import { j as jsxRuntimeExports, u as useCategories, $ as $$AdminLayout } from "../../chunks/useCategories_D3Fh2GCb.mjs";
import { a as reactExports, b as requireReactDom, c as requireReact, R as React } from "../../chunks/_@astro-renderers_BkKWZVaW.mjs";
...
const PostContext = reactExports.createContext(void 0);
const PostProvider = ({ children }) => {
  const [postData, setPostDataState] = reactExports.useState(initialPostData);
  const isEditMode = reactExports.useMemo(() => !!postData.id, [postData.id]);
  const updatePostData = reactExports.useCallback((data) => {
    setPostDataState((prev) => ({ ...prev, ...data }));
  }, []);
  const setPostData = reactExports.useCallback((data) => {
    setPostDataState(data);
  }, []);
  const resetPostData = reactExports.useCallback(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PostContext.Provider, { value, children });
};
const usePost = () => {
  const context = reactExports.useContext(PostContext);
  if (!context) {
...
const Link$1 = createLucideIcon("link", __iconNode$e);
/**
 * @license lucide-react v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function useCloudinaryUpload({
  ...
  const openUploadWidget = reactExports.useCallback(() => {
    if (!window.cloudinary) {
...
const FeaturedImageUpload = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-semibold text-gray-400 mb-2", children: "Imagen Destacada" }),
    postData.featuredImage ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group overflow-hidden rounded-lg", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black opacity-0 group-hover:opacity-40 transition-opacity duration-200 pointer-events-none" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-white/10 rounded-full group-hover:bg-secondary-light/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-8 h-8 text-gray-400 group-hover:text-secondary-light transition-colors" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-gray-400 group-hover:text-secondary-light transition-colors", children: "Click para subir imagen" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-1", children: "PNG, JPG, WebP hasta 10MB" })
          ] })
        ] })
      }
    )
...
const ContentData = () => {
  const { postData, updatePostData } = usePost();
  const [currentTag, setCurrentTag] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "title", className: "block text-sm font-semibold text-gray-400 mb-2", children: "Título" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "slug", className: "block text-sm font-semibold text-gray-400 mb-2", children: "Slug" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "shortDescription", className: "block text-sm font-semibold text-gray-400 mb-2", children: "Descripción corta" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            id: "shortDescription",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right text-sm text-gray-500 mt-1", children: [
          postData.excerpt.length,
          " / 160"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturedImageUpload, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "category", className: "block text-sm font-semibold text-gray-400 mb-2", children: "Categoría" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", className: "bg-[var(--color-primary)]", children: "Selecciona una categoría" }),
                categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: cat.value, className: "bg-[var(--color-primary)]", children: cat.label }, cat.value))
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "tags", className: "block text-sm font-semibold text-gray-400 mb-2", children: "Etiquetas" }),
        ...
        postData.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-3", children: postData.tags.map((tag, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
...
var getYoutubeEmbedUrl$2 = (nocookie, isPlaylist) => {
  if (isPlaylist) {
...
var getEmbedUrlFromYoutubeUrl = (options) => {
  ...
  if (url.includes("youtu.be")) {
    ...
    return `${getYoutubeEmbedUrl$2(nocookie)}${id}`;
  }
  ...
  let outputUrl = `${getYoutubeEmbedUrl$2(nocookie, matches2[1] === "list")}${matches2[2]}`;
  const params = [];
  ...
  if (params.length) {
    outputUrl += `${matches2[1] === "v" ? "?" : "&"}${params.join("&")}`;
  }
  return outputUrl;
};
...
const TextFormattingGroup = ({ editor }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-neutral-300/5 backdrop-blur-xl rounded-full px-2 py-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bold$1, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Italic$1, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Underline$1, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    )
  ] });
};
const TextAlignmentGroup = ({ editor }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: BUTTON_GROUP_CLASS, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(TextAlignStart, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(TextAlignCenter, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(TextAlignEnd, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(TextAlignJustify, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    )
  ] });
};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "normal", style: { fontSize: "14px" }, children: "Texto normal" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", style: { fontSize: "24px", fontWeight: "bold" }, children: "Título 1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "2", style: { fontSize: "18px", fontWeight: "bold" }, children: "Título 2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "3", style: { fontSize: "14px", fontWeight: "bold" }, children: "Título 3" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: BUTTON_GROUP_CLASS, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(List, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListOrdered, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListTree, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    )
  ] });
};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-6 bg-gray-300/30 mx-1" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link$1, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: BUTTON_BASE_CLASS,
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image$1, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: BUTTON_BASE_CLASS,
        type: "button",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "text-[var(--color-secondary)]", size: 18 })
      }
    )
  ] });
};
const ToolbarDivider = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-6 bg-gray-600 mx-1" });
};
const EditorToolbar = ({ editor }) => {
  const [, setUpdateTrigger] = reactExports.useState(0);
  reactExports.useEffect(() => {
    const updateToolbar = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 flex gap-4 items-center mb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TextFormattingGroup, { editor }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-6 mx-4 bg-gray-600" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TextAlignmentGroup, { editor }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ToolbarDivider, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FontSizeSelector, { editor }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ToolbarDivider, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ListsGroup, { editor }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ToolbarDivider, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MediaGroup, { editor })
  ] });
};
const RichTextEditor = () => {
  const editor = useEditorConfig();
  const { updatePostData, postData } = usePost();
  const contentLoadedRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto rounded-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-4 text-[var(--color-secondary)]", children: "Contenido" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(EditorToolbar, { editor }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-xl text-white border border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EditorContent, { editor }) })
  ] });
};
...
const PostActions = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4 mt-6 p-4 glass rounded-lg border border-white/10", children: [
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-full mb-2 right-0 bg-red-100 border border-red-400 text-red-700 px-4 py-2 rounded", children: error })
  ] });
};
...
function PostLoader() {
  ...
  const [showLoader, setShowLoader] = reactExports.useState(() => {
    if (typeof window !== "undefined") {
      return !!localStorage.getItem("isLoadingPost");
    }
    return false;
  ...
  if (showLoader || isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-12 w-12 border-4 border-gray-200 border-t-secondary-light" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-medium text-gray-600", children: "Cargando post..." })
    ] }) });
  }
  return null;
}
const FormContent = () => {
  ...
  if (showLoader || isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(PostLoader, {});
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ContentData, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RichTextEditor, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PostActions, {})
  ] });
};
const CreatePostForm = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PostProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(FormContent, {}) });
};
function PageTitle() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-4 text-[var(--color-secondary)]", children: isEditMode ? "Editar Publicación" : "Crear Publicación" });
}
