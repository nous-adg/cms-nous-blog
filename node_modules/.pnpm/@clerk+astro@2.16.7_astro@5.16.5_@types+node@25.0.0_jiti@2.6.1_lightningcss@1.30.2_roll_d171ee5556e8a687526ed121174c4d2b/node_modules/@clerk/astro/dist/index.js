// src/integration/create-integration.ts
...
// src/integration/create-integration.ts
var buildEnvVarFromOption = (valueToBeStored, envName) => {
...
function createIntegration() {
  return (params) => {
    ...
    const clerkJSUrl = params?.clerkJSUrl;
    const clerkJSVariant = params?.clerkJSVariant;
    const clerkJSVersion = params?.clerkJSVersion;
    return {
      ...
      hooks: {
        "astro:config:setup": ({ config, injectScript, updateConfig, logger, command }) => {
          ...
          injectScript(
            "before-hydration",
            `
            ${command === "dev" ? `console.log('${name}',"Initialize Clerk: before-hydration")` : ""}
